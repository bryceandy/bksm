        ...
        <div id="appBody">
            ...
            <div class="col-12">
                <ul class="priceLists">
                    ...
                    <li class="purp">Sports - 90min <span class="pin text-right">90,000</span></li>
                    <li class="purp">Deep Tissue - 60min <span class="pin text-right">60,000</span></li>
                    <li class="purp">Deep Tissue - 90min <span class="pin text-right">90,000</span></li>
                    ...
                    <li class="purp">Aromatherapy - 90min <span class="pin text-right">90,000</span></li>
                    <li class="purp">Swedish - 60min <span class="pin text-right">60,000</span></li>
                    <li class="purp">Swedish - 90min <span class="pin text-right">90,000</span></li>
                    <li class="purp">Thai - 60min <span class="pin text-right">60,000</span></li>
                    <li class="purp">Thai - 90min <span class="pin text-right">90,000</span></li>
            ...
            <div class="col-12">
                <ul class="priceLists">
                    ...
                    <li class="purp">Full Back <span class="pin text-right">20,000</span></li>
                    <li class="purp">Full Body <span class="pin text-right">150,000</span></li>
                </ul>
            </div><br /><br />
            ...
            <div class="col-12">
                <ul class="priceLists">
                    <li class="purp">Facial Scrub <span class="pin text-right">20,000</span></li>
                    <li class="purp">Full Facial Treatment <span class="pin text-right">50,000</span></li>
